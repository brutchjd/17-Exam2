...
class Triangle(object):
    ...
    def area(self):
        ...
        s = 0.5 * (self.a.distance_from(self.b) + self.a.distance_from(self.c) + self.b.distance_from(self.c))
        area_value = (s
                      * (s - self.a.distance_from(self.b))
                      * (s - self.b.distance_from(self.c))
                      * (s - self.c.distance_from(self.a))) ** 0.5
        return round(area_value, 1)
    ...
    def shrink_or_expand(self, f):
        ...
        if self.biggest_area < self.area():
            self.biggest_area = self.area()
    ...
    def return_doubled_triangle(self):
        ...
        new_a = Point(self.a.x * 2, self.a.y * 2)
        new_b = Point(self.b.x * 2, self.b.y * 2)
        new_c = Point(self.c.x * 2, self.c.y * 2)
